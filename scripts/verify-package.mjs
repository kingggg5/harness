...
const requiredFiles = [
	...
	"agents/harness-qa.md",
	"agents/harness-researcher.md",
	"hooks/hooks.json",
	"hooks/guard-canonical-files.js",
	"hooks/session-status.js",
	...
	"skills/best-in-code/assets/templates/ANTHROPIC-ADAPTER.json",
	...
	"skills/best-in-code/scripts/anthropic_adapter.py",
	"skills/best-in-code/scripts/anthropic_adapter_tests.py",
